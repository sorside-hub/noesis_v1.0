...
export const ExportNoteModal: React.FC<ExportNoteModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 backdrop-blur-xs animate-in fade-in duration-150">
      {/* Modal Container */}
      <div 
        className="w-full max-w-md bg-bg-quaternary border border-border-default rounded-2xl shadow-2xl overflow-hidden animate-in zoom-in-95 duration-150"
      ...
      >
        ...
        <div className="flex items-center justify-between px-5 py-4 border-b border-border-default bg-bg-quaternary">
          <div className="flex items-center gap-2.5 min-w-0">
            ...
            <div className="min-w-0">
              <h2 className="text-sm font-bold text-text-primary truncate">Export Catatan</h2>
              <p className="text-[11px] text-text-secondary truncate">{node.name}</p>
            </div>
          </div>
          <button
            type="button"
            onClick={onClose}
            className="p-1.5 rounded-lg text-icon-accent hover:text-text-primary hover:bg-bg-hover transition-colors cursor-pointer"
          >
            <X size={16} />
          </button>
        </div>
        ...
        <div className="p-5 space-y-2.5">
          ...
          >
            <div className="flex items-center gap-3 min-w-0">
              ...
              <div className="min-w-0">
                <div className="text-xs font-bold text-text-primary group-hover:text-accent-primary transition-colors">
                  Markdown (.md)
                </div>
        ...
        {/* Footer */}
        <div className="px-5 py-3 border-t border-border-default bg-bg-quaternary flex justify-end">
          <button
            type="button"
            onClick={onClose}
            className="px-4 py-1.5 text-xs font-medium rounded-lg bg-bg-surface hover:bg-bg-hover text-text-secondary hover:text-text-primary border border-border-default transition-colors cursor-pointer"
          >
            Tutup
          </button>
        </div>
