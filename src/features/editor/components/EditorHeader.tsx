    ...
    <header className="flex items-center justify-between bg-bg-primary border-b border-border-default z-30 relative px-2 h-10 shrink-0 select-none">
      ...
      <div className="flex items-center shrink-0 pr-1">
        ...
        <button
          ...
          className="lg:hidden w-7 h-7 flex items-center justify-center rounded-md text-icon-accent hover:text-text-primary hover:bg-bg-hover transition-colors cursor-pointer shrink-0"
        >
          <PanelLeft size={16} />
        </button>
        ...
        <button
          ...
          onClick={handleLeftHeaderToggle}
          title="Toggle Left Sidebar"
          className="hidden lg:flex w-7 h-7 items-center justify-center rounded-md text-icon-accent hover:text-text-primary hover:bg-bg-hover transition-colors cursor-pointer shrink-0"
        >
          <PanelLeft size={16} />
        </button>
        ...
        >
            ...
            return (
              ...
              >
                ...
                <button
                  ...
                  title="Tutup Tab"
                  className="w-4 h-4 flex items-center justify-center rounded-xs hover:bg-bg-hover text-icon-accent hover:text-text-primary transition-colors cursor-pointer shrink-0 opacity-70 group-hover:opacity-100"
                >
                  <X size={12} />
                </button>
              </div>
          ...
          <div className="flex items-center h-8 shrink-0">
            <button
              ...
              title="Buka Tab Baru"
              className="w-7 h-7 flex items-center justify-center rounded-md text-icon-accent hover:text-text-primary hover:bg-bg-hover transition-colors shrink-0 cursor-pointer"
            >
              <Plus size={15} />
            </button>
          </div>
      ...
      <div className="flex items-center gap-1 shrink-0 pl-1">
        ...
        <button
          ...
          className="relative w-7 h-7 flex items-center justify-center rounded-md text-icon-accent hover:text-text-primary hover:bg-bg-hover transition-colors cursor-pointer shrink-0"
        >
          <PanelRight size={16} />
