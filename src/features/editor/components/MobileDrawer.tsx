  ...
  return (
    <div className="lg:hidden">
      ...
      <div
        ...
        className={`fixed inset-y-0 ${positionClass} w-full h-full ${side === 'left' ? 'bg-bg-secondary' : 'bg-bg-surface'} z-50 overflow-hidden flex flex-col will-change-transform`}
      >
        {children}
      </div>
    </div>
