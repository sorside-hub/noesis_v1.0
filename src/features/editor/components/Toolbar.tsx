...
export const Toolbar = ({ editor }: ToolbarProps) => {
  ...
  const baseClasses = "flex items-center gap-1 p-2 bg-bg-primary border-border-default overflow-x-auto whitespace-nowrap w-full [&::-webkit-scrollbar]:hidden [-ms-overflow-style:none] [scrollbar-width:none] toolbar-container";
      ...
      {isToolbarStripVisible && (
        ...
        >
          ...
          <button
            ...
            className="p-2 rounded-md transition-colors shrink-0 text-icon-accent hover:bg-bg-hover hover:text-text-primary cursor-pointer"
