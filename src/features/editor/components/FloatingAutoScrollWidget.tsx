...
export const FloatingAutoScrollWidget: React.FC = () => {
  ...
  return (
    <div
      ...
      className="fixed top-[4rem] right-3 z-40 w-[44px] flex flex-col items-center gap-1 p-1.5 bg-bg-surface/95 backdrop-blur-md rounded-2xl shadow-2xl select-none animate-in fade-in slide-in-from-top-2 duration-200"
    >
