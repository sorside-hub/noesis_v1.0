          ...
          {activeTab === 'upload' ? (
            <div className="space-y-4">
              ...
              <div 
                ...
                className={`relative flex flex-col items-center justify-center p-6 rounded-2xl cursor-pointer transition-all border-0 ${
                  isDragOver
                    ? 'bg-accent-primary/10'
                    : selectedFile
                    ? 'bg-bg-secondary'
                    : 'bg-bg-secondary hover:bg-bg-hover/70'
                }`}
              >
                {selectedFile ? (
                  <div className="flex flex-col items-center text-center space-y-2">
                    <div className="w-12 h-12 rounded-xl bg-bg-primary text-accent-primary flex items-center justify-center font-bold text-xs uppercase tracking-wider">
              ...
              <div className="flex items-center gap-2">
                <div className="relative flex-1">
                  ...
                  <input
                    ...
                    className="w-full pl-8 pr-3.5 py-2 text-xs bg-bg-secondary rounded-xl text-text-primary placeholder:text-text-muted/50 focus:outline-hidden focus:ring-1 focus:ring-accent-primary transition-all border-0"
                  />
                </div>
                <button
                  type="button"
                  ...
                  className="p-2 rounded-xl bg-bg-secondary hover:bg-bg-hover text-text-muted hover:text-text-primary transition-colors disabled:opacity-50 cursor-pointer border-0"
                >
                    ...
                    return filtered.map((item) => {
                      ...
                      return (
                        <div 
                          ...
                          className="group flex items-center justify-between p-2.5 rounded-xl bg-bg-secondary hover:bg-bg-hover/80 transition-all cursor-pointer text-left border-0"
                        >
                          <div className="flex items-center gap-3 min-w-0 pr-2">
                            <div className="w-8 h-8 rounded-lg bg-bg-primary text-accent-primary flex items-center justify-center shrink-0 font-bold text-[10px] uppercase tracking-wider">
                              {ext}
                            </div>
                          ...
                          <button
                            type="button"
                            className="shrink-0 px-3 py-1.5 rounded-lg text-[11px] font-medium text-text-primary bg-bg-primary group-hover:bg-accent-primary group-hover:text-accent-contrast transition-colors border-0 shadow-2xs"
                          >
                            Sisipkan
                          </button>
                        </div>
