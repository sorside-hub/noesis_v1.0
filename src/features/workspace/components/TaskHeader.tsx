        ...
        {totalCount > 0 && (
          <div className="flex items-center gap-1">
            <button
              ...
              className="p-1 text-icon-secondary hover:text-status-success hover:bg-bg-hover rounded-md transition-colors cursor-pointer"
            ...
            <button
              ...
              className="p-1 text-icon-secondary hover:text-status-warning hover:bg-bg-hover rounded-md transition-colors cursor-pointer"
