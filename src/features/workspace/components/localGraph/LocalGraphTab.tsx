  ...
  return (
    <div className="w-full h-full flex flex-col overflow-hidden bg-bg-secondary">
      ...
      <div ref={containerRef} className="flex-1 w-full relative min-h-[300px] overflow-hidden">
        {stats.totalNodes <= 1 && (
          <div className="absolute inset-0 z-10 flex flex-col items-center justify-center p-6 pointer-events-none text-center bg-bg-secondary/60 backdrop-blur-2xs">
            <div className="p-3 bg-accent-soft rounded-full border border-border-default text-accent-primary mb-2">
              <Link2 size={20} />
            </div>
            ...
            <p className="text-[11px] text-text-muted mt-1 max-w-[220px]">
              Add <span className="text-link-primary font-mono">[[Wikilinks]]</span> or <span className="text-status-warning font-mono">#tags</span> in the editor to link notes.
            </p>
          </div>
        )}
