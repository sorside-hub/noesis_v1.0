      ...
      <div key={node.fullTag} className="space-y-0.5">
        ...
        {hasChildren && expanded && (
          <div className="relative">
            ...
            <div
              className="absolute top-0 bottom-1 border-l border-border-default/40 pointer-events-none"
                  ...
                  return (
                    ...
                    >
                      <FileText
                        ...
                        className={twMerge(
                          'shrink-0 transition-colors',
                          isSelected ? 'text-text-inverse' : 'text-text-secondary group-hover:text-text-primary'
                        )}
                      />
            ...
            filteredFlatTags.map((item) => {
              ...
              return (
                <div key={item.tag} className="rounded-lg overflow-hidden transition-colors">
                  ...
                  {expanded && (
                    <div className="pl-6 pr-1 py-0.5 space-y-0.5 border-l border-border-default/40 ml-3.5 my-0.5">
                      {item.files.map((file) => {
                        const isSelected = file.id === activeFileId;
                        return (
                          <button
                          ...
                          >
                            ...
                            />
                            <span className={twMerge("truncate flex-1", isSelected ? "text-text-inverse font-medium" : "text-text-secondary group-hover:text-text-primary")}>{file.name}</span>
                          </button>
                        );
                      })}
                    </div>
