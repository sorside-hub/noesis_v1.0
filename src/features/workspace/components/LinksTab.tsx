            ...
            {semanticLinks.map((node) => (
              ...
              >
                <div className="flex items-center gap-2 truncate min-w-0">
                  ...
                  <span className="text-xs font-medium text-text-primary group-hover:text-link-primary truncate">
                    {node.name}
                  </span>
                </div>
                <ExternalLink size={12} className="text-icon-secondary opacity-0 group-hover:opacity-100 transition-opacity shrink-0 ml-2" />
              </button>
            ))}
          </div>
        )}
        ...
        {outgoingLinks.length === 0 ? (
          ...
          <div className="space-y-1.5">
            {outgoingLinks.map((item, idx) => (
              ...
              >
                <div className="flex items-center gap-2 truncate min-w-0">
                  <Link2 size={14} className="text-icon-secondary shrink-0 group-hover:text-link-primary" />
                  <span className="text-xs font-medium text-text-primary truncate group-hover:text-link-primary">
                    {item.targetName}
                  </span>
                </div>
                {item.matchedNode ? (
