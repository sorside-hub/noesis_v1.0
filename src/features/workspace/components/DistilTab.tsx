  ...
  return (
    <div className="space-y-4 animate-in fade-in duration-150">
      ...
      <button
        ...
        className="w-full flex items-center justify-center gap-2 bg-accent-primary hover:opacity-90 disabled:opacity-30 disabled:cursor-not-allowed text-accent-contrast text-xs font-semibold py-2.5 rounded-xl transition-all shadow-xs cursor-pointer"
      >
        {isDistiling ? (
          <>
